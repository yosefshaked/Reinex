...
export default async function (context, req) {
  ...
  if (method === 'get') {
    ...
    if (readError) {
      ...
      const classified = classifyTenantDbError(readError, {
        resource: 'Employees',
        operation: 'select',
  ...
  if (existingError) {
    ...
    const classified = classifyTenantDbError(existingError, {
      resource: 'Employees',
      operation: 'select',
      tenantAuth: context.__tenantAuthDiagnostics,
    });
  ...
  if (!existing) {
    ...
    if (createError) {
      ...
      const classified = classifyTenantDbError(createError, {
        resource: 'Employees',
        operation: 'insert',
        tenantAuth: context.__tenantAuthDiagnostics,
      });
  ...
  if (updateError) {
    ...
    const classified = classifyTenantDbError(updateError, {
      resource: 'Employees',
      operation: 'update',
      tenantAuth: context.__tenantAuthDiagnostics,
    });
