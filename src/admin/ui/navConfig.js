...
export const ADMIN_NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/system-admin/admin-tools',
        label: 'Admin Tools',
        icon: Wrench,
        status: 'live',
        description: 'Focused admin diagnostics for HMO claims and other operational issues.',
      },
      {
        to: '/system-admin/org-purge',
        label: 'Org Purge',
        icon: Skull,
        status: 'live',
        description: 'Permanently delete all data for a customer organization. Irreversible.',
      },
    ],
  },
  {
