const ACTION_LABELS_HE = {
  ...
  'student.lesson_attendance_changed': 'עודכן סטטוס נוכחות תלמיד',
...
const DETAIL_LABELS_HE = {
  ...
  impacts: 'השפעות',
  projected: 'חיזוי',
  requested_instructor_compensation_decision: 'החלטת פיצוי למדריך',
  action_label_he: 'כותרת פעולה',
  message: 'פירוט',
  type: 'סוג השפעה',
  amount_before: 'סכום קודם',
  ...
  finalized_payroll_run_ids: 'הרצות שכר שסגרו את השיעור',
};
...
const VALUE_LABELS_BY_KEY = {
  ...
  requested_instructor_compensation_decision: {
    compensated: 'לפצות את המדריך',
    not_compensated: 'לא לפצות את המדריך',
  },
  ...
  type: {
    participant_status: 'שינוי סטטוס תלמיד',
    lesson_status: 'שינוי סטטוס שיעור',
    billing_reversal: 'החזר חיוב תלמיד',
    billing_charge: 'חיוב תלמיד',
    ...
    hmo_task_resolve: 'סגירת משימת גורם מממן',
    instructor_compensation_decision: 'החלטת פיצוי למדריך',
  },
  role: {
    owner: 'בעלים',
