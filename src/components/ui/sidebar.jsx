...
import { sidebarMenuButtonVariants } from './helpers/sidebarVariants'
...
import { SidebarContext, useSidebar } from './helpers/sidebarContext'
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>מציג את תפריט הצד בגרסת המובייל.</SheetDescription>
          </SheetHeader>
...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}>
      <PanelLeft />
      <span className="sr-only">החלפת מצב תפריט הצד</span>
    </Button>
  );
})
...
const SidebarRail = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      data-sidebar="rail"
      aria-label="החלפת מצב תפריט הצד"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="החלפת מצב תפריט הצד"
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:start-0 sm:flex",
...
// sidebarMenuButtonVariants moved to helpers/sidebarVariants.js
