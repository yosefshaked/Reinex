  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed start-[50%] z-50 flex flex-col w-[calc(100%-1rem)] border bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=open]:slide-in-from-left-1/2 sm:w-full sm:rounded-lg",
...
const DialogHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-1.5 text-end mb-6", className)}
    {...props} />
)
