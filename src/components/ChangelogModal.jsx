...
const LAUNCH_VERSION = {
  version: '0.0.1',
  date: '2026-04-30',
  displayDate: '30 באפריל 2026',
  title: 'השקת Reinex',
  description:
    'Reinex יוצאת לדרך כמערכת תפעולית לניהול ארגונים טיפוליים וחינוכיים: מקום אחד לתיאום שיעורים, ניהול משתתפים, תיעוד נוכחות, תהליכי חיוב ושכר, ומעקב אחר חריגים תפעוליים.',
  sections: [
    {
    ...
    },
    {
      title: 'מה הלאה',
      items: [
        'נמשיך לשפר את חוויית לוח השנה, תהליכי הסגירה והמסכים הפיננסיים לפי שימוש אמיתי ומשוב מהשטח.',
