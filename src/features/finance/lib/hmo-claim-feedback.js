  ...
  switch (code) {
    case 'hmo_claim_batch_empty':
      return {
        ...
        description: 'רעננו את המסך, ודאו שהשיעורים סומנו כנוכחים ושהשורות עדיין מופיעות תחת תביעות גורם מממן פתוחות. אם הן אמורות להיות זמינות ולא מופיעות, בדקו את השיעור, האישור והגורם המממן מול נתוני המערכת.',
      };
    case 'hmo_claim_line_not_claimable':
      return {
        title: 'חלק מהשורות שנבחרו כבר לא ניתנות לדרישה',
        description: 'רעננו את תביעות הגורם המממן, בחרו מחדש רק שורות פעילות, וודאו שלא נבחרו שורות שכבר השתנו או טופלו. אם הבעיה חוזרת, בדקו את פרטי השיעור והאישור לפני ניסיון נוסף.',
      };
    ...
    case 'hmo_authorization_claim_limit_exceeded': {
      ...
      return {
        ...
        description: `${limitDetails ? `${limitDetails}. ` : ''}בדקו את אישור הגורם המממן של התלמיד וודאו שלא מנסים לצרף שיעור מעבר למכסה המאושרת. אם נדרש, עדכנו את האישור לפני יצירת הדרישה.`.trim(),
      };
    }
    ...
    default:
      return {
        title: 'פעולת תביעת גורם מממן נכשלה',
