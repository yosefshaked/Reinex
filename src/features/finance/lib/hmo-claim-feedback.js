  ...
  switch (code) {
    case 'hmo_claim_batch_empty':
      return {
        ...
        description: 'רעננו את המסך, ודאו שהשיעורים סומנו כנוכחים ושהשורות עדיין מופיעות תחת תביעות HMO פתוחות. אם הן אמורות להיות זמינות ולא מופיעות, בדקו אותן דרך Admin Tools.',
      };
    case 'hmo_claim_line_not_claimable':
      return {
        title: 'חלק מהשורות שנבחרו כבר לא ניתנות לדרישה',
        description: 'רעננו את תביעות ה-HMO, בחרו מחדש רק שורות פעילות, וודאו שלא נשלחו מזהי משימות ישנים או שורות שכבר השתנו. אם הבעיה חוזרת, בדקו את השורה ב-Admin Tools.',
      };
    ...
    default:
      return {
        ...
        description: error?.message
          ? `המערכת החזירה: ${error.message}. אם לא ברור מה לתקן, בדקו את השורה או הדרישה דרך Admin Tools.`
          : 'רעננו את המסך ונסו שוב. אם התקלה חוזרת, בדקו את המקרה דרך Admin Tools.',
      };
  }
}
