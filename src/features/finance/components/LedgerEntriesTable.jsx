              ...
              <React.Fragment key={row.key}>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        ...
                        {canExpand ? (
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            className="h-7 gap-1 rounded-lg px-2 text-xs text-slate-600 hover:text-slate-900"
                ...
                {canExpand && isExpanded ? (
                  <TableRow className="bg-slate-50/40 hover:bg-slate-50/40">
                    <TableCell colSpan={7} className="px-5 py-3 sm:px-6">
                      <div className="space-y-2 rounded-xl border border-slate-200 bg-white p-3">
                        {row.childRows.map((child) => (
                          <div key={child.key} className="grid gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-700 md:grid-cols-[minmax(140px,1fr)_minmax(200px,2fr)_minmax(80px,auto)_minmax(80px,auto)]">
